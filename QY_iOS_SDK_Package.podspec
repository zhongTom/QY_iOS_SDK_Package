Pod::Spec.new do |s|
    ...
    s.source   = { :git => 'https://github.com/zhongTom/QY_iOS_SDK_Package.git', :tag => "8.4.2" }
    s.platform = :ios, '9.0'
    ...
    s.resources  = ['**/Resources/QYResource.bundle', '**/Resources/QYLanguage.bundle', '**/Resources/QYCustomResource.bundle', '**/Resources/QYConfigResource.bundle']
    s.dependency 'NIMSDK_LITE', '9.2.8'
