 ...
 * 取消或恢复发布本地视频流。
 * @note
 * - 该方法仅适用于视频主流，若您希望取消或恢复发布视频辅流，请调用 {@link INERtcEngineEx#muteLocalVideo:streamType:} 方法。
 ...
 * @note 
 * - 该方法仅适用于视频主流，若您希望为辅流通道设置摄像头的采集配置，请调用 {@link INERtcEngineEx#setCameraCaptureConfig:streamType:}。
 ...
 *         - 30005（kNERtcErrInvalidState）：当前状态不支持的操作，比如引擎尚未初始化。
 *         - 30403（kNERtcErrMediaOpenBannedByServer）：该用户被服务器禁言。
 * @endif
 */
